      ...
      <section className="faq-section">
        <div className="container">
          ...
          <div className="faq-grid">
            ...
            <div className="faq-item">
              <h3>🕒 מה שעות הפעילות?</h3>
              <p>החנות פתוחה ראשון-חמישי 7:00-19:00, יום שישי 7:00-14:00.</p>
            </div>
            <div className="faq-item">
              <h3>🥬 איך אתם שומרים על הטריות?</h3>
              <p>כל המוצרים שלנו מגיעים טריים מהחקלאים מדי יום. אנחנו משתמשים במקררים מתקדמים לשמירה על הטריות.</p>
            </div>
            <div className="faq-item">
              <h3>🌱 יש לכם מוצרים אורגניים?</h3>
              <p>כן! יש לנו מגוון רחב של פירות וירקות אורגניים מוסמכים. המוצרים מסומנים בבירור בחנות ובאתר.</p>
            </div>
            <div className="faq-item">
              <h3>📱 איך מזמינים דרך האתר?</h3>
              <p>פשוט בחרו את המוצרים, הוסיפו לעגלה, מלאו פרטי משלוח ותשלום - וזהו! תקבלו אישור הזמנה מיידי.</p>
            </div>
            <div className="faq-item">
              <h3>🎁 יש הנחות ללקוחות קבועים?</h3>
              <p>בהחלט! לקוחות רשומים מקבלים 5% הנחה על כל הזמנה, ובמועדון הלקוחות יש הטבות נוספות.</p>
            </div>
            <div className="faq-item">
              <h3>❄️ איך אתם מטפלים במוצרים קפואים?</h3>
              <p>המוצרים הקפואים נשמרים בטמפרטורה נכונה לאורך כל הדרך, ומגיעים אליכם בשקיות מיוחדות לשמירה על הקור.</p>
            </div>
            <div className="faq-item">
              <h3>🚫 מה קורה אם אני לא בבית?</h3>
              <p>אנחנו מתקשרים לפני הגעה. אם אתם לא בבית, אפשר לתאם משלוח חוזר או השארת המוצרים אצל שכן.</p>
            </div>
            <div className="faq-item">
              <h3>🏷️ האם המחירים באתר זהים לחנות?</h3>
              <p>כן, המחירים זהים. לפעמים יש מבצעים מיוחדים באתר או בחנות - אבל המחיר הבסיסי תמיד זהה.</p>
            </div>
          </div>
        </div>
      </section>
